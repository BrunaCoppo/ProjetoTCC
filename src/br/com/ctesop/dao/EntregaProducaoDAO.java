...
public class EntregaProducaoDAO {
    ...
    public static int inserir(EntregaProducao entregaProducao, Conexao c) throws Exception {
        ...
        String sql = "insert into tbentregaproducao (codcooperativa, codtbsafra, dataentrega, quantidadeentregue , quantidadedesconto, descricao, status) values (?, ?, ?, ?, ?, ?, ?)";
    ...
    private static void alterar(EntregaProducao entregaProducao, Conexao c) throws Exception {
        ...
        String sql = "update tbentregaproducao set codcooperativa=?, codtbsafra=?, dataentrega=?, quantidadeentregue=?, quantidadedesconto=?, descricao=?, status=?, where codcompra=?";
    ...
    public static ObservableList<EntregaProducao> listar() throws Exception {
        ...
        while (rs.next()) {
            ...
            entregaProducao.setSafra(new Safra(rs.getInt("e.codtbsafra"), rs.getString("p.nomeproduto")));
